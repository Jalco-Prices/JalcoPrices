...
import RelatedProductsGridComponent from "./RelatedProductsGridComponent";
import BarcodeModalComponent from "./BarcodeModalComponent";
// Models
import { ProductType, AnyProductType } from "@/models/ProductModel"
// Icons
import { BarcodeIcon, InfoCircleIcon, CashIcon, LinkIcon, ArrowDownIcon, ArrowUpIcon } from "@/icons/Icons"
// Images
        ...
        <>
            ...
            {isShowBarcode &&
                <BarcodeModalComponent
                    ...
                    minimoMayoreo={localProduct.minimoMayoreo}
                    selectedProducts={selectedProducts}
